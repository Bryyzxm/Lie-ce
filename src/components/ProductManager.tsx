...
export default function ProductManager({ products, setProducts }: ProductManagerProps) {
  const [form, setForm] = useState({ id: "", name: "", stock: "", price: "", code: "" });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setForm({ id: "", name: "", stock: "", price: "", code: "" });
  };
  ...
  return (
    <section className="mb-8">
      ...
      <form onSubmit={handleSubmit} className="mb-6 grid grid-cols-1 sm:grid-cols-5 gap-4">
        <input
          type="text"
          name="name"
